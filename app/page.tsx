    ...
    <>
      <div className="container">
        ...
        >
          ...
          <Paragraph>
            Peyronnet Group is the home of innovation and an experience creator.
            It has different divisions focused on different areas: Léo
            Corporation creates applications aimed at improving productivity,
            Devyus builds tools for developers and Synapsy creates AI-related
            web experiences.
          </Paragraph>
          ...
          <div className="mt-8 flex space-x-4">
            <HoverCard>
              <HoverCardTrigger>
                <Link href={"https://leocorporation.dev"}>
                  <Image
                    height={48}
                    width={48}
                    className="opacity-50 saturate-0 transition duration-300 hover:opacity-100 hover:saturate-100"
              ...
              <HoverCardContent>
                Application and experience creator since 2017 that makes people
                more productive.
              </HoverCardContent>
            </HoverCard>
            ...
            <HoverCard>
              <HoverCardTrigger>
                <Link href={"https://dev.peyronnet.group"}>
                  <Image
                    height={48}
                    width={48}
                    className="opacity-50 saturate-0 transition duration-300 hover:opacity-100 hover:saturate-100"
              ...
              <HoverCardContent>
                Organization that specializes in making high-quality developer
                libraries that help developers create amazing applications.
              </HoverCardContent>
            </HoverCard>
            ...
            <HoverCard>
              ...
              <HoverCardContent>
                Where Artificial Intelligence Meets Experiences. Synapsy focuses
                on making AI-powered web experiences.
              </HoverCardContent>
            </HoverCard>
          </div>
        </section>
